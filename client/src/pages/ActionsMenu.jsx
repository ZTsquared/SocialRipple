...
export default function ActionsMenu() {
	...
	//Claire : this will be a click to the single Action page (we can keep it on same page if we want, just on another page for now), for now it is a link in the return statement so I can play with the data. if we have images i would the image to be clickable..
